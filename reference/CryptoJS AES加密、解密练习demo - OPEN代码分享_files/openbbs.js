...
function pickedTags(){
    ...
    var setupTagDeleteEvents = function(obj,tag_store,tagname,reason,send_ajax){
        obj.unbind('mouseover').bind('mouseover', function(){
            $(this).attr('src', mediaUrl('images/close-small-hover.png'));
        });
        obj.unbind('mouseout').bind('mouseout', function(){
            $(this).attr('src', mediaUrl('images/close-small-dark.png'));
        });
        obj.click( function(){
    ...
    var handlePickedTag = function(obj,reason){
        ...
        if (!(tagname in to_target)){
            ...
            sendAjax(tagname,reason,'add',function(){
                ...
                del_link.attr('src', mediaUrl('images/close-small-dark.png'));
